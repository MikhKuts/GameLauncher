...
public class ChooseWindow {
	...
	private AnchorPane scrollContent = new AnchorPane();
	private VBox vbox = new VBox();
	private Button finishButton = new Button("Finish");
	private Button cancelButton = new Button("Cancel");
	private CheckBox selectAllCheckBox = new CheckBox("Select all");
	private Label instructionLabel = new Label("Select the file to be added.");
	private ArrayList<CheckBox> selectGames = new ArrayList<CheckBox>();
	...
	private AnchorPane init() {
        ...
        finishButton.setOnAction(e -> {
        	...
        	ForGL.configManage.addListOfGames(temp);
